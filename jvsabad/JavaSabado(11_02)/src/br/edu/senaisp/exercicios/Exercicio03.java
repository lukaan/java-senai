...
public class Exercicio03 {
	...
	public static void main(String[] args) {
		...
		double valorTransacao, valorVenal, imposto, valorImposto, maior;
		...
		System.out.println("Insira o valor Venal de referência: ");
		valorVenal = sc.nextDouble();
		
		System.out.println("Insira o percentual do imposto: ");
		...
		valorImposto = ((maior*imposto)/100); 
		
		System.out.println("O valor do imposto a ser pago é de: R$" + valorImposto);
		
	}
}

/*O Imposto sobre a Transmissão de Bens Móveis (ITBI) é aplicado sobre o valor de
